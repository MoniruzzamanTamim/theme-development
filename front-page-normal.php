            ...
            <div class="col xl-6 col-lg-6 col-md-6 col-sm-12 col-12 d-flex align-items-center">
              <div class="slider-content ">
                  ...
                  <div class="banner-btn">
                    <button type="button" class="common-btn banner-btn">Contact Me</button>
                    <?php $cv_pdf_url = get_theme_mod('cv_pdf_file'); ?>
                    <a href="<?php echo esc_url($cv_pdf_url); ?>" class="download-cv-button common-btn banner-btn" download>
      ...
      <div class="col-xl-7 col-lg-7 col-md-7">
        <div class="about-content">
          ...
          <div class="about-service-part">
            <button type="button" class="common-btn about-btn">See All</button>
            <button type="button" class="common-btn about-btn">Contact Me</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-xl-7 col-lg-7 col-md-7">
      <div class="grow-video">
        ...
        <button type="button" class="common-btn grow-button">Contact Me</button>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="build-image">
        ...
        <div class="build-img-inner-content">
          ...
          <button type="button" class="common-btn build-btn ">Contact Me</button>
        </div>
      </div>
